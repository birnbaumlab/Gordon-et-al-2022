...
dataset_filename = '{}dataset_processed_0001.xlsx'.format(base)
...
seqs = {'Consensus Domains':['4-1BB,CD3z'],
         'Barcodes': ['AGGATCAGCAACATTGGG',
                        'ATTAGTGTTTGATCGGTC',
                        'GCGAGTAAGCCCGTAACT',
                        'GGTGAGCACCGTAATAGA',
                        'TGATTCGACCAGGGTCGA']}
'''
        'CD69+PD-1- barcodes':['AGGATCAGCAACATTGGG',
                               'GCGAGTAAGCCCGTAACT',
                               'TCAGACCGACGTCCAGGC',
                               'GGTGAGCACCGTAATAGA',
                               'TCACTCGACGATATGAAC']}
...
tracking = {key:[0]*len(selections) for key in seqs['Consensus Domains'] + seqs['Barcodes']}
