...
selections = ['EGFP+','CD69+ R1','CD69+ R2','CD69+ R3','CD69+PD-1- R1','CD69+PD-1- R2']
...
for i in range(10000):
    figure_folder = os.path.join(base,'figures/statistics_plots_'+str(i).zfill(4))
...
for sel in selections:
    ...
    # filter for 2nd and 3rd gen CARs combined
